    ...
    <section id="prove-product-cat-config">
        <div class="container">
            <div class="page-header">
                <h1> Panel de Administración <small class="tittles-pages-logo"> CATZILLA STORE </small></h1>
            </div>
            <!-- Nav tabs -->
            <ul class="nav nav-tabs" role="tablist">
                ...
                <li role="presentation"><a href="#Admins" role="tab" data-toggle="tab">Administración</a></li>
                    ...
                    <div class="row">
                            ...
                            <div id="add-product">
                                ...
                                <form role="form" action="process/regproduct.php" method="post" enctype="multipart/form-data">
                                    <div class="form-group">
                                        <label>Código de productos </label>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <p class="help-block">Formato de imagenes admitido png, jpg, gif</p>
                                    </div>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="del-prod-form">
                                <h2 class="text-danger text-center"><small><i class="fa fa-trash-o"></i></small>&nbsp;&nbsp;Eliminar producto seleccionado</h2>
                        ...
                        <div class="col-xs-12 col-sm-6">
                            ...
                            <div id="add-provee">
                                ...
                                <form action="process/regprove.php" method="post" role="form">
                                    <div class="form-group">
                                        <label>RFC</label>
                                        <input class="form-control" type="text" name="prove-nit" placeholder="RFC del Proveedor" minlength="12" maxlength="13" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Nombre</label>
                                        <input class="form-control" type="text" name="prove-name" placeholder="Nombre del Proveedor" maxlength="30" required="">
                                    </div>
                                    <div class="form-group">
                                        <label>Dirección</label>
                                        <input class="form-control" type="text" name="prove-dir" placeholder="Dirección del Proveedor" required="">
                                    </div>
                                    <div class="form-group">
